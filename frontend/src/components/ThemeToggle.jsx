  ...
  return (
    <button
      ...
      className={`
        ...
        ${isDark 
          ? "bg-black text-yellow-200 hover:bg-gray-800 hover:shadow-yellow-500/40" 
          : "bg-slate-200 text-gray-800 hover:bg-gray-100 hover:shadow-gray-950"}
      `}
      title={isDark ? "Switch to Light Mode" : "Switch to Dark Mode"}
    >
      {isDark ? <Sun className="w-6 h-6 text-yellow-200" /> : <Moon className="w-6 h-6 text-gray-800" />}
    </button>
  );
}
